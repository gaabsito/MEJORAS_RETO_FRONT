document.addEventListener("DOMContentLoaded", function () {
    const apiUrlPeliculas = "http://localhost:5001/api/peliculas";
    const apiUrlSesiones = "http://localhost:5001/api/sesiones";
    const apiUrlTickets = "http://localhost:5001/api/tickets";
